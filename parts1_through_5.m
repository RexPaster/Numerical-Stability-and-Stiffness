...
%% Part 2
% Q: When 𝑘 = -2 what do you expect to happen to a solution 𝑥(t) as 𝑡
...
% Response
% Q: Find the range of values for ℎ such that the approximation from Euler's
%    method also captures this behaviour. What happens when ℎ is outside of
%    this range?
...
%    You might want to also briefly discuss the case where 𝑘 is large and
%    negative.
